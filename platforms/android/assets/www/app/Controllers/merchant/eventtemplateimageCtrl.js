app.controller('eventtemplateimageCtrl', function ($rootScope, $scope, $http, $location, $stateParams, myAuth) {
    ...
    $scope.getEventTemplateImages = function() {

        //$scope.dataGridOptions = null;
        $scope.edit_mode = false;
        $http({
            method: "GET",
            url: $rootScope.serviceurl + "getImagesByEventTemplate/" + $stateParams.eventTemplateId,
        }).success(function (data) {
   ...
   $scope.$watchCollection('voucherInfo', function() {
    ...
    $scope.save_event_image = function(){
        ...
        $scope.eventimage.event_template_id = $stateParams.eventTemplateId;
        //console.log($scope.eventimage);
        //return false;
        $http({
            method: "POST",
            url: $rootScope.serviceurl+"addEventTemplateImage",
    ...
    $scope.delete_event_image = function(data){
        ...
        if ( window.confirm("Want to delete?") ) {
            $http({
                method: "DELETE",
                url: $rootScope.serviceurl + "deleteEventTemplateImage/"+data,
